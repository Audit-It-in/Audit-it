  ...
  return (
    <Card variant='elevated' className='text-center py-8 bg-gradient-to-r from-primary-50 to-accent-50'>
      <div className='max-w-2xl mx-auto space-y-4'>
        ...
        <p className='text-neutral-700'>Send a contact request to discuss your requirements with this Chartered Accountant.</p>
        ...
        {!isAuthenticated && (
          <p className='text-sm text-neutral-600'>
            <a href='/auth' className='text-primary-600 hover:underline'>Sign up for free</a> to connect with verified Chartered Accountants
          </p>
        )}
      </div>
    </Card>
